...
// Select Group or Individual enrollment 
#define PROV_SYMM_KEY_INDIVIDUAL
//#define PROV_SYMM_KEY_GROUP
...
STRING_HANDLE compute_derived_symm_key(char* device_name, char* group_key)
{
...
int prov_dev_client_ll_symmkey_sample_run()
{
...
// Set the symmetric key if using they auth type
    ...
    printf("CONFIG_REGISTRATION_ID: %s\n", CONFIG_REGISTRATION_ID);
    printf("CONFIG_SYMMETRIC_KEY: %s\n", CONFIG_SYMMETRIC_KEY);

#ifdef PROV_SYMM_KEY_INDIVIDUAL
    prov_dev_set_symmetric_key_info(CONFIG_REGISTRATION_ID, CONFIG_SYMMETRIC_KEY);
#endif
#ifdef PROV_SYMM_KEY_GROUP
    STRING_HANDLE devkey = compute_derived_symm_key(CONFIG_REGISTRATION_ID, CONFIG_SYMMETRIC_KEY);
    prov_dev_set_symmetric_key_info(CONFIG_REGISTRATION_ID, STRING_c_str(devkey));
#endif
